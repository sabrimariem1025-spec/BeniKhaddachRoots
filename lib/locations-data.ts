...
export const locationsData: Location[] = [
 ...
 latitude: 33.26548,
  ...
  },
  {
    ...
    descriptionAr: 'دار نعيم توفر غرفاً مريحة بإطلالة رائعة على الجبال وضيافة تونسية تقليدية',
 ...
 latitude: 33.26190,
    ...
    audioStoryAr: 'مرحباً بكم في دار نعيم، يديرها تاج الدين زغدان، واحة هدوء في الجبال',
    address: 'Beni Khaddach',
    addressAr: 'بني خداش',
    addressFr: 'Beni Khaddach',
    contact: '50 418 968',
